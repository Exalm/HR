...
const consultation = (
 ...
 width="45px" height="45px" viewBox="0 0 64.000000 64.000000"
...
const data = [
    {
        title: 'Персонализированный подбор вакансий',
        dsc: 'Наша команда профессионалов внимательно изучит ваше резюме и подберёт вакансии, соответствующие вашим ожиданиям и возможностям.',
        icon: search,
    },
    {
        title: 'Консультации по развитию карьеры',
        dsc: 'Получайте рекомендации опытных консультантов по построению успешной карьеры, разработке стратегии профессионального роста и подготовке к собеседованиям.',
        icon: consultation,
    },
    {
        title: 'Гарантия трудоустройства',
        dsc: 'Предоставляем гарантию успешного трудоустройства или возврата денежных средств в рамках выбранной услуги.',
        icon: contract
    },
]
